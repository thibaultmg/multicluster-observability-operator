### Generated logs from GitHub Action: [9412427184](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/9412427184)
...
- go: downloading github.com/openshift/hypershift v0.1.36
- go: downloading golang.org/x/exp v0.0.0-20221212164502-fae10dda9338
- go: downloading k8s.io/client-go v0.26.4
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240607034032-ef8c6cd857a7
...
- go: downloading github.com/prometheus-community/prom-label-proxy v0.9.0
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240607034032-ef8c6cd857a7), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240607034032-ef8c6cd857a7), but does not contain package github.com/openshift/hypershift/api/v1beta1
