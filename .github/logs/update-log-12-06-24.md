### Generated logs from GitHub Action: [12193879086](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/12193879086)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20241206012630-913d7e6169c1
...
- go: downloading github.com/openshift/api v0.0.0-20241204141306-c1fdeb0788c1
...
- go: downloading github.com/stolostron/observatorium-operator v0.0.0-20241204071234-735b425f3b5c
...
- go: downloading github.com/openshift/library-go v0.0.0-20241205123836-e8ef1bf0437a
...
- go: downloading k8s.io/kube-aggregator v0.31.3
...
- go: downloading google.golang.org/genproto/googleapis/rpc v0.0.0-20241206012308-a4fef0638583
- go: downloading google.golang.org/genproto v0.0.0-20241206012308-a4fef0638583
...
- go: downloading k8s.io/kms v0.31.3
...
- go: downloading google.golang.org/genproto/googleapis/api v0.0.0-20241206012308-a4fef0638583
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20241206012630-913d7e6169c1), but does not contain package github.com/openshift/hypershift/api/hypershift/v1alpha1
...
- go: all: module k8s.io/api@upgrade found (v0.31.3), but does not contain package k8s.io/api/resource/v1alpha2
- go: all: module k8s.io/client-go@upgrade found (v0.31.3), but does not contain package k8s.io/client-go/applyconfigurations/resource/v1alpha2
- go: all: module k8s.io/client-go@upgrade found (v0.31.3), but does not contain package k8s.io/client-go/informers/resource/v1alpha2
- go: all: module k8s.io/client-go@upgrade found (v0.31.3), but does not contain package k8s.io/client-go/kubernetes/typed/resource/v1alpha2
- go: all: module k8s.io/client-go@upgrade found (v0.31.3), but does not contain package k8s.io/client-go/kubernetes/typed/resource/v1alpha2/fake
- go: all: module k8s.io/client-go@upgrade found (v0.31.3), but does not contain package k8s.io/client-go/listers/resource/v1alpha2
