### Generated logs from GitHub Action: [9074554733](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/9074554733)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240514044556-4195621fdd73
...
- go: downloading github.com/aws/aws-sdk-go v1.53.1
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240514044556-4195621fdd73), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240514044556-4195621fdd73), but does not contain package github.com/openshift/hypershift/api/v1beta1
