### Generated logs from GitHub Action: [9755822878](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/9755822878)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240701143254-b24ea2639ddb
...
- go: downloading github.com/aws/aws-sdk-go v1.54.12
...
- go: github.com/openshift/hypershift/api@v0.0.0-20240701143254-b24ea2639ddb requires go >= 1.22.0; switching to go1.22.4
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240701143254-b24ea2639ddb), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240701143254-b24ea2639ddb), but does not contain package github.com/openshift/hypershift/api/v1beta1
