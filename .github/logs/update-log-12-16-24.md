### Generated logs from GitHub Action: [12346921269](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/12346921269)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20241215232147-ba6cf381cd3d
...
- go: downloading github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring v0.79.0
- go: downloading go.uber.org/zap v1.27.0
- go: downloading github.com/prometheus-operator/prometheus-operator v0.79.0
- go: downloading k8s.io/api v0.32.0
- go: downloading github.com/openshift/api v0.0.0-20241213110156-c117e1ee5a9c
...
- go: downloading github.com/openshift/library-go v0.0.0-20241213140326-389618b826f5
...
- go: downloading github.com/prometheus-operator/prometheus-operator/pkg/client v0.79.0
...
- go: downloading github.com/cncf/xds v0.0.0-20241213214725-57cfbe6fad57
...
- go: downloading cloud.google.com/go/compute v1.31.0
- go: downloading cloud.google.com/go v0.116.0
- go: github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring@v0.79.0 requires go >= 1.23.0; switching to go1.23.4
...
- go: all: module google.golang.org/grpc@upgrade found (v1.69.0), but does not contain package google.golang.org/grpc/internal/grpcrand
- go: all: module google.golang.org/grpc@upgrade found (v1.69.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/bootstrap
- go: all: module google.golang.org/grpc@upgrade found (v1.69.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/tlscreds
...
- go: all: module k8s.io/client-go@upgrade found (v0.32.0), but does not contain package k8s.io/client-go/listers/resource/v1alpha2
