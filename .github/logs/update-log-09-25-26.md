### Generated logs from GitHub Action: [36128783397](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/36128783397)
...
- go: downloading github.com/fullstorydev/grpcurl v1.9.4
- go: downloading go.etcd.io/etcd/etcdctl/v3 v3.5.0
- go: downloading go.etcd.io/etcd/v3 v3.5.0
- go: downloading go.etcd.io/etcd/etcdctl/v3 v3.7.2
- go: downloading go.etcd.io/etcd v3.3.27+incompatible
- go: downloading go.etcd.io/etcd/v3 v3.7.2
- go: downloading github.com/google/trillian v1.8.0
...
- go: downloading github.com/jhump/protoreflect v1.18.1
...
- go: downloading go.etcd.io/etcd/client/v2 v2.305.34
- go: downloading go.etcd.io/etcd/etcdutl/v3 v3.5.0
- go: downloading go.etcd.io/etcd/etcdutl/v3 v3.7.2
- go: downloading go.etcd.io/etcd/tests/v3 v3.5.0
- go: downloading go.etcd.io/etcd/tests/v3 v3.7.2
...
- go: downloading github.com/envoyproxy/go-control-plane/envoy v1.39.0
...
- go: downloading go.etcd.io/etcd/raft/v3 v3.5.34
- go: downloading go.etcd.io/etcd/server/v3 v3.7.2
- go: downloading bitbucket.org/creachadair/shell v0.0.6
- go: downloading bitbucket.org/creachadair/shell v0.0.9
- go: downloading github.com/bgentry/speakeasy v0.1.0
- go: downloading github.com/bgentry/speakeasy v0.2.0
- go: downloading github.com/dustin/go-humanize v1.0.1
- go: downloading github.com/dustin/go-humanize v1.1.0
- go: downloading github.com/olekukonko/tablewriter v0.0.5
- go: downloading github.com/olekukonko/tablewriter v1.1.5
- go: downloading go.etcd.io/etcd/pkg/v3 v3.5.13
- go: downloading go.etcd.io/etcd/pkg/v3 v3.7.2
...
- go: downloading github.com/cncf/xds v0.0.0-20260202195803-dba9d589def2
...
- go: downloading github.com/mattn/go-runewidth v0.0.30
...
- go: all: module github.com/google/trillian@upgrade found (v1.8.0), but does not contain package github.com/google/trillian/merkle/hashers
- go: all: module github.com/google/trillian@upgrade found (v1.8.0), but does not contain package github.com/google/trillian/merkle/logverifier
- go: all: module github.com/google/trillian@upgrade found (v1.8.0), but does not contain package github.com/google/trillian/merkle/rfc6962
...
- go: all: module go.etcd.io/etcd/etcdctl/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/etcdctl/v3/ctlv2
- go: all: module go.etcd.io/etcd/etcdctl/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/etcdctl/v3/ctlv2/command
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/datadir
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/etcdserver/api/v2auth
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/etcdserver/api/v2discovery
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/etcdserver/api/v2http
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/etcdserver/api/v2http/httptypes
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/etcdserver/api/v2v3
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/mvcc
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/mvcc/backend
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/mvcc/buckets
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/wal
- go: all: module go.etcd.io/etcd/server/v3@upgrade found (v3.7.2), but does not contain package go.etcd.io/etcd/server/v3/wal/walpb
...
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/cdsbalancer
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/clusterimpl
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/clustermanager
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/clusterresolver
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/loadstore
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/outlierdetection
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/priority
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/ringhash
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/balancer/wrrlocality
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/clusterspecifier
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/clusterspecifier/rls
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/httpfilter
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/httpfilter/fault
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/httpfilter/rbac
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/httpfilter/router
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/resolver
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/resolver/internal
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/server
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/bootstrap
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/load
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/tlscreds
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/transport
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdslbregistry
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdslbregistry/converter
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdsresource
- go: all: module google.golang.org/grpc@upgrade found (v1.84.0), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdsresource/version
...
- go: all: module open-cluster-management.io/addon-framework@upgrade found (v1.3.1), but does not contain package open-cluster-management.io/addon-framework/pkg/addonmanager/controllers/managementaddon
...
- go: all: module sigs.k8s.io/controller-runtime@upgrade found (v0.25.1), but does not contain package sigs.k8s.io/controller-runtime/pkg/ratelimiter
