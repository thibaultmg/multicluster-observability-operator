### Generated logs from GitHub Action: [13006263093](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/13006263093)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20250128054916-3171b6dcb83e
...
- go: downloading github.com/openshift/api v0.0.0-20250128061932-d2791f98ff08
...
- go: downloading github.com/evanphx/json-patch/v5 v5.9.10
- go: downloading github.com/evanphx/json-patch v5.9.10+incompatible
...
- go: downloading github.com/openshift/client-go v0.0.0-20250125113824-8e1f0b8fa9a7
...
- go: downloading github.com/openshift/library-go v0.0.0-20250127111945-0f76e23726cd
...
- go: downloading github.com/google/cel-go v0.23.0
...
- go: downloading k8s.io/kms v0.32.1
...
- go: downloading go.starlark.net v0.0.0-20250127224320-2fb1215d657f
...
- go: github.com/openshift/api@v0.0.0-20250128061932-d2791f98ff08 requires go >= 1.23.0; switching to go1.23.5
...
- go: all: module k8s.io/client-go@upgrade found (v0.32.1), but does not contain package k8s.io/client-go/kubernetes/typed/resource/v1alpha2
