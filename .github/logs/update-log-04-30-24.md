### Generated logs from GitHub Action: [8891775314](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/8891775314)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240430063311-d3abe8048288
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240430063311-d3abe8048288), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240430063311-d3abe8048288), but does not contain package github.com/openshift/hypershift/api/v1beta1
