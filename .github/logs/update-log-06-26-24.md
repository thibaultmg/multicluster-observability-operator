### Generated logs from GitHub Action: [9674399367](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/9674399367)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240626023537-8df96cff3a0a
...
- go: downloading github.com/aws/aws-sdk-go v1.54.8
...
- go: github.com/openshift/hypershift/api@v0.0.0-20240626023537-8df96cff3a0a requires go >= 1.22.0; switching to go1.22.4
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240626023537-8df96cff3a0a), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240626023537-8df96cff3a0a), but does not contain package github.com/openshift/hypershift/api/v1beta1
