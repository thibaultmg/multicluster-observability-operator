### Generated logs from GitHub Action: [12407224647](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/12407224647)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20241219031235-19d3a678a288
...
- go: downloading github.com/openshift/api v0.0.0-20241218213630-875a6f0bf850
...
- go: downloading github.com/openshift/client-go v0.0.0-20241217083110-35abaf51555b
- go: downloading github.com/openshift/library-go v0.0.0-20241218091209-6018a90c28d0
...
- go: all: module google.golang.org/grpc@upgrade found (v1.69.2), but does not contain package google.golang.org/grpc/internal/grpcrand
- go: all: module google.golang.org/grpc@upgrade found (v1.69.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/bootstrap
- go: all: module google.golang.org/grpc@upgrade found (v1.69.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/tlscreds
