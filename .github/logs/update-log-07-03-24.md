### Generated logs from GitHub Action: [9772705911](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/9772705911)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240703054445-cbe7cb6b6714
...
- go: github.com/openshift/hypershift/api@v0.0.0-20240703054445-cbe7cb6b6714 requires go >= 1.22.0; switching to go1.22.5
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240703054445-cbe7cb6b6714), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240703054445-cbe7cb6b6714), but does not contain package github.com/openshift/hypershift/api/v1beta1
