### Generated logs from GitHub Action: [11967396248](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/11967396248)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20241122054703-cf790ae5ec07
...
- go: downloading github.com/openshift/api v0.0.0-20241121204516-053bb8a33f6d
...
- go: downloading github.com/openshift/library-go v0.0.0-20241120135057-fc703a7407c9
...
- go: downloading go.starlark.net v0.0.0-20241119230559-d4d7611b1759
...
- go: github.com/prometheus-operator/prometheus-operator/pkg/apis/monitoring@v0.78.2 requires go >= 1.23; switching to go1.23.3
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20241122054703-cf790ae5ec07), but does not contain package github.com/openshift/hypershift/api/hypershift/v1alpha1
...
- go: all: module sigs.k8s.io/controller-runtime@upgrade found (v0.19.2), but does not contain package sigs.k8s.io/controller-runtime/pkg/ratelimiter
