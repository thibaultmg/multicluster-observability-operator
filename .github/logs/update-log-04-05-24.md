### Generated logs from GitHub Action: [8565737088](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/8565737088)
...
- go: downloading github.com/openshift/hypershift/api v0.0.0-20240404213434-2fbe4a43a5eb
...
- go: downloading github.com/prometheus-operator/prometheus-operator v0.73.0
...
- go: downloading github.com/prometheus-operator/prometheus-operator/pkg/client v0.73.0
...
- go: downloading github.com/aws/aws-sdk-go v1.51.15
...
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240404213434-2fbe4a43a5eb), but does not contain package github.com/openshift/hypershift/api/v1alpha1
- go: all: module github.com/openshift/hypershift/api@upgrade found (v0.0.0-20240404213434-2fbe4a43a5eb), but does not contain package github.com/openshift/hypershift/api/v1beta1
