### Generated logs from GitHub Action: [33864809366](https://github.com/thibaultmg/multicluster-observability-operator/actions/runs/33864809366)
...
- go: downloading google.golang.org/genproto/googleapis/api v0.0.0-20260831171406-18b4a7587f8a
...
- go: downloading github.com/mattn/go-runewidth v0.0.29
...
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/cdsbalancer
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/clusterimpl
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/clustermanager
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/clusterresolver
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/loadstore
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/outlierdetection
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/priority
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/ringhash
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/balancer/wrrlocality
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/clusterspecifier
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/clusterspecifier/rls
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/httpfilter
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/httpfilter/fault
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/httpfilter/rbac
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/httpfilter/router
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/resolver
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/resolver/internal
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/server
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/bootstrap
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/load
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/tlscreds
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/transport
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdslbregistry
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdslbregistry/converter
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdsresource
- go: all: module google.golang.org/grpc@upgrade found (v1.83.2), but does not contain package google.golang.org/grpc/xds/internal/xdsclient/xdsresource/version
...
- go: all: module sigs.k8s.io/controller-runtime@upgrade found (v0.25.0), but does not contain package sigs.k8s.io/controller-runtime/pkg/ratelimiter
